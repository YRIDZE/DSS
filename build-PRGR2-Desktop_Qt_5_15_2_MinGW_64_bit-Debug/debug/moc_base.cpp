...
QT_MOC_LITERAL(1, 5, 17), // "on_cansel_clicked"
...
QT_MOC_LITERAL(7, 66, 7) // "alltext"

    },
    "base\0on_cansel_clicked\0\0on_save_clicked\0"
    "open\0std::string\0filename\0alltext"
};
...
void base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_cansel_clicked(); break;
        case 1: _t->on_save_clicked(); break;
        case 2: _t->open((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2]))); break;
        default: ;
        }
    }
}
